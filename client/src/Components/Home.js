...
export default function Home() {
  ...
  const [drawerItem, setDrawerItem] = React.useState("LaneView");
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          <ListItem button onClick={() => setDrawerItem("LaneView")}>
            <ListItemIcon>
              <InboxIcon />
            </ListItemIcon>
            <ListItemText primary={"Lane And Parking View"} />
          </ListItem>
        </List>
        <Divider />
        <List>
          <ListItem button onClick={() => setDrawerItem("ParkingLog")}>
            <ListItemIcon>
              <InboxIcon />
            </ListItemIcon>
